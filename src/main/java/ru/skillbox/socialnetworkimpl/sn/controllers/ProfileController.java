...
public class ProfileController {
    ...
    @PutMapping("me")
    public ResponseEntity<ResponseApi> editCurrentUser(HttpServletRequest request,
                                                       @RequestBody PersonEditBody personEditBody) {
        return profileService.editCurrentUser(request.getSession(), personEditBody);
    }

    @DeleteMapping("me")
    public ResponseEntity<ResponseApi> deleteCurrentUser(HttpServletRequest request) {
        return profileService.deleteCurrentUser(request.getSession());
    }

    @GetMapping("{id}")
    public ResponseEntity<ResponseApi> getUserById(HttpServletRequest request,
                                                   @PathVariable("id") long id) {
        return profileService.getUserById(request.getSession(), id);
    }

    @GetMapping(value = "{id}/wall", params = {"offset", "itemPerPage"})
    public ResponseEntity<ResponseApi> getPersonsWallPosts(HttpServletRequest request,
                                                           @PathVariable("id") long id,
    ...
    public ResponseEntity<ResponseApi> addPostToUsersWall(HttpServletRequest request,
                                                          @PathVariable("id") long id,
    ...
    public ResponseEntity<ResponseApi> searchPerson(HttpServletRequest request,
    ...
    @PutMapping("block/{id}")
    public ResponseEntity<ResponseApi> blockUserById(HttpServletRequest request,
                                                     @PathVariable("id") long id) {
        return profileService.blockUserById(request.getSession(), id);
    }

    @DeleteMapping("block/{id}")
    public ResponseEntity<ResponseApi> unblockUserById(HttpServletRequest request,
                                                       @PathVariable("id") long id) {
